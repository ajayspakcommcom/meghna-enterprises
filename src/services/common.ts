...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
    ...
    <div
        ...
        <img src="http://13.235.48.111/images/billing-logo.jpg" alt="Signature" style="width: 750px; height: 85px; display: block; margin: 0 0 0 0;" />
...
export const sentBillingHtmlTemplateOnEmail = (data?: any) => {
    const template = `
    <!DOCTYPE html>
<html lang="en">
...
<body style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
    ...
    <div
        style="max-width: 1200px; margin: auto; padding: 20px; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); border:2px solid #ddd;">
        ...
        <div style="margin-top: 10px; margin-bottom: 10px;">
            <p style="text-align: center; font-size: 12px; margin: 0; line-height: 20px; font-weight: 300;">
             ...
             <table style="width: 100%; border-collapse: collapse; font-size: 12px; border: 1px solid #ddd;"cellspacing="0" cellpadding="0">
                 <tbody>
                    <tr>
                       <td>
                           <div style="padding: 10px;">
